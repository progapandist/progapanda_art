...
// app/javascript/controllers/random_image_controller.js
var FORMAT = "avif";
var RESIZE = "rs:fit:4000:3000/gravity:sm";

class random_image_controller_default extends Controller {
...
class sessions_controller_default extends Controller {
  static values = {
    sessionId: String
  };
  connect() {
    console.log("Connected to the session controller, session ID:", this.sessionIdValue);
...
//# debugId=802FA80072632D5864756e2164756e21
